...
Set-CoaVariables -Domain "qa01alexandriava.net" -CoaSkuInformationWorkers "qa01alexandriava:ENTERPRISEPACK" -CoaSkuFirstlineWorkers "qa01alexandriava:ENTERPRISEPACK" -CoaSkuExoArchive "" -CoaSkuExoAtp "" -authOrig "CN=O365 Administrator,OU=Admin,OU=Generics,OU=O365,DC=alexfstest,DC=net"
...
#>
Remove-CoaUser -SamAccountName Test.Test05
# Remove-CoaUser -CommaSeparatedSamAccountNames "module.test5","module.test6"
# Set-CoaMailboxConfiguration -Verbose
